...
(async ()=> {
    ...
    for (let i = 0; i < clips.length; ++i) {
        ...
        if (datetime > '2022-05' && datetime < '2022-06') {
            ...
            // 处理playUrl
            let modified = false;
            let newPlayUrl = playUrl.replace('bili.lubo.media/d/ASOUL/', '');
            ...
            if (newPlayUrl.indexOf(' 嘉然 ') !== -1) {
                ...
                newPlayUrl = 'bili.lubo.media/d/ASOUL/' + newPlayUrl + '.mp4';
            ...
            // 处理redirectUrl
            let newRedirectUrl = redirectUrl.replace('bili.lubo.media/ASOUL/', '');
            ...
            if (newRedirectUrl.indexOf(' 嘉然 ') !== -1) {
                ...
                newRedirectUrl = 'bili.lubo.media/ASOUL/' + newRedirectUrl + '.mp4';
